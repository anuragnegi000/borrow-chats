    ...
    <NavigationMenu className="z-[5] mt-10 flex justify-center w-[50rem] m750:max-w-[300px]">
      <NavigationMenuList className="m750:max-w-[300px]">
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className=" z-[100]"> {/* Adjust z-index here */}
      ...
      <img src="https://avatars.githubusercontent.com/u/115611556?v=4" height={40} width={40} className='rounded-full'></img>
    </NavigationMenu>
  );
}
