...
export default function HeroVideoDialog({
  ...
  return (
    <div className={cn("relative", className)}>
      <div
        className="relative cursor-pointer group max-w-2xl mx-auto" // Added max-width constraint
      ...
      <AnimatePresence>
        {isVideoOpen && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-md" // Adjusted z-index to ensure it's at the top
          >
            <motion.div
              {...selectedAnimation}
              transition={{ type: "spring", damping: 30, stiffness: 300 }}
              className="relative w-[90vw] md:w-[60vw] max-w-5xl aspect-video mx-auto" // Adjusted width constraints for the video
            >
              <motion.button
